                    ...
                    <div class="row">
                            <div class="form-left h-100 py-5 px-5">
                                ...
                                <form action="{{route('login.mahasiswa')}}" method="POST" class="row g-4">
                                    ...
                                    @endif
                                        <div class="col-12">
                                            <label>NIM/Email<span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="bi bi-person-fill"></i></div>
                                                        <input type="text" value="{{ old('login') }}" name="login" class="form-control" placeholder="Masukkan NIM atau Email" required>
                                                        @error('login')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>EMAIL ATAU NIM TIDAK TERDAFTAR</strong>
                                                        </span>
                                                    @enderror
                                            </div>
                                        </div>
