                                            ...
                                            <td>
                                                @if($row->dosen_id === auth()->guard('dosen')->user()->id)
                                                    <form action="{{ route('kelasdosen.destroy', $row->id) }}" method="post">
                                                        ...
                                                        <a href="{{Route('kelasdosen.show', $row->id)}}" class="btn btn-success btn-sm">Input Siswa</a>
                                                        <a href="{{Route('kelasdosen.listsiswa', $row->id)}}" class="btn btn-primary btn-sm">List Siswa</a>
                                                        <a href="{{Route('dosen.tugaslist', $row->id)}}" class="btn btn-info btn-sm">Tugas</a>
