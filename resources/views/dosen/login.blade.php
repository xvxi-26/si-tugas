                                    ...
                                    @endif
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" value="{{ old('nidn') }}" name="nidn" class="form-control @error('nidn') is-invalid @enderror">
                                                @error('nidn')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>NIDN INI TIDAK TERDAFTAR</strong>
                                                    </span>
                                                @enderror
                                            </div>
                                        </div>
